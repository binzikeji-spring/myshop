    ...
    <div class="beij_center dengl_jvz">
        <div class="login_form">
            ...
            <div class="kengl_kuang">
                ...
                <form action="/login" method="post">
                    <div class="txt_kuang">
                        ...
                        <input id="verification" name="verification" type="text" class="itxt"  placeholder="验证码" style=" width: 140px; top: -15px;" />
                        <img id="validataCode" src="/verification" style="cursor: pointer;" title="看不清？换一张" />
                    </div>
                    <div class="remember">
                        <div class="fl">
                            <input type="checkbox" >
            ...
            <div class="corp_login">
                ...
                <div class="regist_link"><a href="/zhuce" target="_blank"><b></b>立即注册</a></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        // 刷新验证码
        $("#validataCode").bind("click", function () {
